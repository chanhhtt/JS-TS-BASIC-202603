...
//Hình thái 3: Dùng object có sẵn scopt bên ngoài
...
//-> điểm lưu ý: closure ko sao chép nguyên object -> nó giữ quyền truy cập tới biến/ tham chiếu đang
// trỏ tới object

//Closure giải quyết vấn đề gì
//Global scope = ai cx truy cập đc
let soThuTu = 0;
...
// biến soThuTu vào balo kí ức. Do đó biến soThuTu bất tử và tiếp tục tăng lên mỗi lần
// gọi layIdMoi()
