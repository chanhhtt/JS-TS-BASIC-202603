...
//vấn đề
//nornalize ko tạo object mới -> sửa luôn input gốc -> nếu chỗ khác vẫn nghi input là dữ liệu ban đầu thì sẽ lỗi logic
...
//formInput chính là loginTestData[i].formInput chạy test

//const { defaultRole = "guest", allowedRoles, minPasswordLength = 8 } = options;

// nếu options.defaultRole mà ko có thì defaultRole nhận giá trị mặc định
